...
export default function Home() {
  return (
    <>
      ...
      >
        <header class="text-gray-800 py-16 md:py-24">
          <div class="container mx-auto flex flex-col md:flex-row items-center justify-evenly px-4 md:px-8">
            <div class="md:w-1/2 mb-8 md:mb-0">
              <h1 className='text-4xl font-bold tracking-tight text-gray-600 sm:text-5xl'>Johan Bautista</h1>
              <p class="text-lg md:text-xl mt-2">Passionate front-end developer dedicated to crafting digital tools for the web.</p>
