  ...
  return (
    <>
      <section className="py-16 md:py-24">
        <div className="flex flex-col md:flex-row items-center justify-between md:min-h-screen">
          <div className="mb-8 md:mb-0">
            <h1 className='text-4xl font-bold sm:text-5xl'>Johan Bautista</h1>
            <p className="text-lg md:text-xl mt-2">Front-end developer dedicated to crafting digital tools for the web.</p>
